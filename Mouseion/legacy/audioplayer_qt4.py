...
class AudioPlayer(QtGui.QWidget):
    def __init__(self, url, parent = None):
        ...
        self.play_pause.setIcon(QtGui.QIcon(r'images/icons/player_play.jpg'))
    ...
    def stateChanged(self, new, old):
        if new == Phonon.PlayingState:
            self.play_pause.setIcon(QtGui.QIcon(r'images/icons/player_pause.jpg'))
        else:
            self.play_pause.setIcon(QtGui.QIcon(r'images/icons/player_play.jpg'))
